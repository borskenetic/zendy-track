                ...
                <form id="studentForm" action="{{ route('students.store') }}" method="POST"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6" hidden>
                            <input type="text" name="qrcode" class="form-control" placeholder="QR Code"
                                value="{{ old('qrcode') }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            <select name="course" class="form-select">
                                ...
                                <option value="{{ $program->program_code }}" {{ old('course')==$program->program_code ?
                                    'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <input type="text" name="emergency_person" class="form-control"
                                placeholder="Emergency Contact Person" value="{{ old('emergency_person') }}">
                        </div>

                        <div class="col-md-6">
                            <input type="text" name="emergency_relationship" class="form-control"
                                placeholder="Relationship" value="{{ old('emergency_relationship') }}">
                        </div>

                        <div class="col-md-6">
                            <input type="text" name="emergency_number" class="form-control"
                                placeholder="Emergency Contact Number" value="{{ old('emergency_number') }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            <select name="year" class="form-select">
                                ...
                                <option value="First Year" {{ old('year')=='First Year' ? 'selected' : '' }}>First Year
                                </option>
                                <option value="Second Year" {{ old('year')=='Second Year' ? 'selected' : '' }}>Second
                                    Year</option>
                                <option value="Third Year" {{ old('year')=='Third Year' ? 'selected' : '' }}>Third Year
                                </option>
                                <option value="Fourth Year" {{ old('year')=='Fourth Year' ? 'selected' : '' }}>Fourth
                                    Year</option>
                                <option value="Fifth Year" {{ old('year')=='Fifth Year' ? 'selected' : '' }}>Fifth Year
                                </option>
                            </select>
                        </div>
