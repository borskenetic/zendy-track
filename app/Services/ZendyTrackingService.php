...
class ZendyTrackingService
{
    ...
    public function logAccess(Request $request, string $action, ?User $user = null, array $extra = []): ZendyLog
    {
        ...
        return ZendyLog::create([
            ...
            'action' => $action,
            'first_name' => $user?->fname ?? $extra['first_name'] ?? '',
            'last_name' => $user?->lname ?? $extra['last_name'] ?? '',
            'email' => $user?->email ?? $extra['email'] ?? '',
            'course' => $user?->course ?? $extra['course'] ?? '',
            'department' => $user?->department ?? $extra['department'] ?? '',
            'campus' => $user?->campus ?? $extra['campus'] ?? '',
